...
<body>
	...
	<span>任课教师</span>
	<td><select id="teacher_id" name="teacher_id" class="input-medius">
			<option value="">-请选择-</option>
	</select></td>
	</br>
	<span>上课教室</span>
	<td><select id="classroom_id" name="classroom_id" class="input-medius">
			<option value="">-请选择-</option>
	</select></td>
	</br>
	<span>上课人数</span>
	...
	<input id="btn_insert" type="submit" value="添加课程" />
</body>
