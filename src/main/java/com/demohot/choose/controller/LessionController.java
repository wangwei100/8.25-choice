...
import com.demohot.choose.controller.vo.LessionVo;
...
import com.demohot.choose.model.PageBean;
...
public class LessionController {
	...
	@ResponseBody
	public ModelAndView doChoice(Integer lession_id, Integer user_id, HttpSession session) {
		// 判断用户登录
		User loginUser = (User) session.getAttribute("loginUser");
		if (null == loginUser) {
			return new ModelAndView("redirect:/user/login");
	...
	@ResponseBody
	public ModelAndView doInsert(Integer type, String name, Integer teacher_id, Integer classroom_id,
			Integer max_number, Integer remain, HttpSession session) {
		// 判断用户登录
		User loginUser = (User) session.getAttribute("loginUser");
		if (null == loginUser) {
			return new ModelAndView("redirect:/user/login");
